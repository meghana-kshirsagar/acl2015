...
We present a detailed picture of gains from the additional coverage by analyzing the $F_1$ at the
level of frame-elements (role types). Figure \ref{fig:num_inst} shows the frequency of all roles that appear in the FT-test set.
...
Our models achieve the best improvements for the rarer roles and are on par with the baseline for frequent roles.
