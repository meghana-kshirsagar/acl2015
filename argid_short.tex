...
For every feature $\phi(a, \mathbf{x}, p, f, r)$ in the base feature set, 
we add two disjunctive features:
...
\item\noindent\textbf{parent+siblings} (sibling roles and their parent share features):  
$\phi^{\text{par+sib}}(a,\mathbf{x},p,f,r) = \bigvee_{r' \in \textit{siblings}(r) \cup \{\textit{parent}(r)\}} \phi(a, \mathbf{x}, p, f, r')$.%
