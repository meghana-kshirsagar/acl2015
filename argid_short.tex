...
\nascomment{complete rewrite here, please check carefully}
...
first adds hierarchy (sibling) features, and the second uses PropBank
as guide features.  The best result is the former, gaining 3.95\%
$F_1$ over the baseline.
