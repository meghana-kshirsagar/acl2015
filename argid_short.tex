...
xemplars have not yet been exploited successfully to improve
...
\footnote{Recent work has improved upon global decoding techniques
  \nascomment{also cite Das and Martins et al at *SEM 2012} \citep{tackstrom-15}.
...
\subsection{Exemplars / Domain Adaptation}
\label{sec:frust}
\Citet{daume-07} proposed a feature augmentation approach that was shown to work well in supervised domain adaptation scenarios, 
such as ours.
