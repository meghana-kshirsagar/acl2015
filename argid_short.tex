...
FrameNet lexicon \citep{baker-98}.
...
\nss{Do we use Exemplars test anywhere? Remove that column and just say a small amount of exemplars data was held out?}}
\label{tbl:datastats}
\end{table}
...
%	\begin{subfigure}[b]{0.5\textwidth}
%		\vspace{-1cm}
		\includegraphics[width=0.5\textwidth,trim = 0 0 0 1.5cm]{fig/f1_sorted_by_num_instances}
