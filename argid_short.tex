...
% \right.
% \]
We use a slight variant of this approach.
...
For PropBank, we run\st{ version X of} the Illinois SRL system
...
% \finalversion{
\paragraph{Role-level evaluation.}\nss{Put this before the previous paragraph (``full system'') to avoid confusion?}
