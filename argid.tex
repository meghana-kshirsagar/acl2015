...
\definecolor{mdgreen}{rgb}{0.1,0.5,0}
...
\newcommand{\mkmarker}{\ensuretext{\textcolor{green}{\ensuremath{^{\textsc{M}}_{\textsc{K}}}}}}
...
\newcommand{\nss}[1]{\arkcomment{\nssmarker}{#1}{magenta}}
\newcommand{\mk}[1]{\arkcomment{\mkmarker}{#1}{green}}
...
that belong to the same schema as the target domain (for instance, the exemplars use the same schema as the FT annotations), we use an additional
