...
Each of the three source models produces SRL-style output, where predicates are assigned frames or role-sets, and for each predicate, spans are assigned role labels.
