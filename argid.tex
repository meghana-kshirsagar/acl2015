...
for FT and sentence-level splits for the exemplars, and also the significantly larger (hence broader coverage) exemplars training set. 
...
of the SemLink annotations, giving a minor increase over the baseline. \mk{resulting in a graceful but prompt exit for this resource from further consideration.}
